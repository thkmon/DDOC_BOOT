...
public class LoginUserArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public boolean supportsParameter(MethodParameter parameter) {
        boolean bIsLoginUserAnnotation = parameter.getParameterAnnotation(LoginUser.class) != null;
        boolean bIsUserClass = SessionUser.class.equals(parameter.getParameterType());
        return bIsLoginUserAnnotation && bIsUserClass;
    }
